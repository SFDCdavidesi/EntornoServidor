<?php
//obtenemos los datos del libro a modificar
$bd= new BBDD();
$dl=$bd->dameLibro($codigolibro); //dl=datosLibro
?>
<form action="<?=$_SERVER['PHP_SELF'];?>" method="post">
<input type="hidden" name="accion" value="modificarLibro">
<input type="hidden" name="codigo" value="<?=$dl["codigo"]?>">

  <div class="form-group">
    <label for="titulo">Título</label>
    <input type="text" class="form-control" id="titulo" name="titulo" aria-describedby="tituloHelp" value="<?=$dl["titulo"]?>">
...
pintaAutores($dl["codigo_autor"]);
  ...
  <div class="form-check">
    <input type="checkbox" class="form-check-input" id="disponible" name="disponible" <?=($dl["disponible"]?"checked":"");?>>
